...
# SECTION 1: INDUSTRY & COMPANY INSIGHTS
    ...
    for source_no, raw_name, sector in IPER_2026_COMPANIES:
        ...
        company_rows.append({"No": source_no, "Company": clean_name, "Sector": sector, "Note": note, "Website": official_site})
                                ...
                                "json_schema": {
                                    ...
                                    "schema": {
                                        ...
                                        "properties": {
                                            ...
                                            "FillerWordsUsed": {"type": "array", "items": {"type": "object", "properties": {"word": {"type": "string"}, "count": {"type": "integer", "minimum": 0}}, "required": ["word", "count"], "additionalProperties": False}},
